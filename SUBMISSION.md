...
- **Lighting / demographics:** MobileFaceNet is trained on large, diverse face datasets; MLKit detection is robust across pose/illumination; the cosine threshold is **tunable in-app** (Config) to trade off FAR/FRR per site. Benchmarked on **LFW** (a demographically broad standard) at 98.3%.
